...
-- SELECT COUNT(DISTINCT lenguaje) AS  cantidad_leng FROM usuarios_lenguajes WHERE edad > 25;
...
-- SELECT email, nombre FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL 
...
-- SELECT * FROM usuarios_lenguajes WHERE edad >29 ORDER BY LENGTH(lenguaje) DESC LIMIT 1;


-- Ejercicio 35: Seleccionar los usuarios y mostrar la diferencia entre su edad y la edad promedio de todos los usuarios
-- SELECT *, (edad - (SELECT AVG(edad) FROM usuarios_lenguajes)) AS diferencia_edad FROM usuarios_lenguajes;s
...
-- SELECT LENGTH(nombre) AS logitud_nombre FROM usuarios_lenguajes WHERE lenguaje IS NOT NULL;
...
-- SELECT COUNT(apellido) FROM usuarios_lenguajes WHERE apellido LIKE 'P%' AND edad <28;
